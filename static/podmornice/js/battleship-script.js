...
function handleNewGame() {
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            const game_hash = xhr.response.game_hash
            ...
            document.getElementById('hash_game_text').innerHTML = game_hash
        }
    }
    xhr.send()
}
...
function openWindowSetup() {
    ...
    if (igrac1.search(donjaCrta) >= 0 && igrac2.search(donjaCrta) >= 0 && igrac1.search(broj) >= 0 && igrac2.search(broj) >= 0 && igrac1.length >= 3 && igrac1.length <= 15 && igrac2.length >= 3 && igrac2.length <= 15 && vred == 4) {
        ...
        // localStorage.setItem("flagIgrac", 1);
        var windSetup = window.open("/podmornice/og/setup/", "_self");
    } else {
...
function funkcijaSetup() {
    if (localStorage.getItem("flagIgrac") == 1) {
        ...
        if (localStorage.getItem("flagIgrac") == 2) {
            ...
            document.getElementById("slikaKv1").innerHTML = '<img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" >';
            document.getElementById("slikaKv2").innerHTML = '<img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" > <img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" >';
            document.getElementById("slikaKv3").innerHTML = '<img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" > <img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" > <img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" >';
            document.getElementById("slikaKv4").innerHTML = '<img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" > <img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" > <img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" > <img src="/static/podmornice/battleship-assets/crveni_kvadrat.jpg" >';
...
function otvoriNovProzor() {
    if (localStorage.getItem("flagIgrac") == 1) {
        localStorage.setItem("flagIgrac", 2);
        windSetup = window.open("/podmornice/og/game/", "_self");
    } else {
        if (localStorage.getItem("flagIgrac") == 2) {
            //localStorage.removeItem("flagIgrac");
            localStorage.setItem("flagIgrac", 2);
            windGame = window.open("/podmornice/og/game/", "_self");
        }
    }
...
function callback_proveri(x, y, t) {
...
function proveri(x, y, t) {
    if (localStorage.getItem("flagIgrac") == 2 && t == 1) {
        handleSendMove(x+","+y+","+t, localStorage.getItem('was_hit'))
    } else if (localStorage.getItem("flagIgrac") == 1 && t == 2) {
        handleSendMove(x+","+y+","+t, localStorage.getItem('was_hit'))
    }
}
...
function proveriIgraca1() {
    ...
    if (g != 1) {
        ...
        window.open("/podmornice/og/", "_self");
    }
    g = null;
}
